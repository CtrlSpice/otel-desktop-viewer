...
export function getDuration(startTimestamp : string, endTimestamp:string){
    try {
        ...
        let startTimeNs = startTimeMs*1e6 + Timestamp.fromString(startTimestamp).getNano();
        let endTimeNs = endTimeMs*1e6 + Timestamp.fromString(endTimestamp).getNano()
...
export function getDurationString(startTimestamp : string, endTimestamp:string){
